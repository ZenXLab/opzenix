    ...
    >
      ...
      <div className="h-16 border-b border-border bg-card/50 flex items-center justify-between px-6 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground">Opzenix Pipeline Wizard</h2>
            <p className="text-xs text-muted-foreground">Universal Execution Platform</p>
          </div>
        </div>
      ...
      {/* Footer */}
      <div className="h-16 border-t border-border bg-card/50 flex items-center justify-between px-6 shrink-0">
        <Button
          variant="ghost"
          onClick={handleBack}
